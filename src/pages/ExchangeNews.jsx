...
const ExchangeNews = () => {
 ...
 {
      exchanges && exchanges?.data?.news?.map((currency , i) =>(
        <NewsCard key={i} title={currency.article_title} description={currency.source} newsUrl={currency.article_url} image={currency.article_photo_url} />
      ))
     } 
